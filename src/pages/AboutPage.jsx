    ...
    <div className="w-full">
      ...
      <section className="bg-gray-900 text-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* Hero Content */}
          <h1 className="text-5xl font-bold mb-4">About Centauri-Pro Consulting</h1>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-12">
            <h2 className="text-4xl font-bold text-gray-900">What Sets Us Apart</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white border border-gray-200 p-6 rounded-lg hover:border-orange-500 transition">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Licensed & Certified</h3>
            ...
            {/* Card 2 */}
            <div className="bg-white border border-gray-200 p-6 rounded-lg hover:border-orange-500 transition">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Full-Service Capability</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            {/* Card 3 */}
            <div className="bg-white border border-gray-200 p-6 rounded-lg hover:border-orange-500 transition">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Compliance Excellence</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            {/* Card 4 */}
            <div className="bg-white border border-gray-200 p-6 rounded-lg hover:border-orange-500 transition">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Government Contracting</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
