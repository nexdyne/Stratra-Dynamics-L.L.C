  ...
  return (
    <div className="min-h-screen bg-white">
      <section className="bg-gray-900 py-10 md:py-20 xl:py-24">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8">
          ...
          <div className="max-w-3xl">
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">Commissioning, Energy & Sustainability</h1>
      ...
      <section className="py-10 md:py-16 xl:py-20">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Optimizing building performance and sustainability compliance</h2>
      ...
      <section className="py-10 md:py-16 bg-gray-50">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Our Commissioning & Energy Services</h2>
      ...
      <section className="py-10 md:py-16 xl:py-20">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">A performance-driven commissioning process</h2>
      ...
      <section className="py-10 md:py-16 bg-gray-100">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Ready to optimize your building performance?</h2>
          ...
          <Link to="/contact" className="inline-block bg-orange-600 hover:bg-orange-700 text-white px-6 sm:px-8 py-4 text-base font-semibold rounded transition-colors min-h-[52px] w-full sm:w-auto text-center">Schedule a Consultation</Link>
        </div>
      </section>
    </div>
  )
