...
const EnvironmentalConsultingPage = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-10 md:py-16 xl:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Science-driven assessments that protect people and property</h2>
      ...
      <section className="py-10 md:py-16 xl:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">A rigorous, science-based approach</h2>
