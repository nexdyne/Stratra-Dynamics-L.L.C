    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-10 md:py-16 bg-white">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6">Why Choose Our Smart City IT Solutions</h2>
      ...
      <section className="bg-gray-50 py-8">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6">Ready to Build Your Smart City Platform?</h2>
