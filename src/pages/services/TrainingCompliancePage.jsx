  ...
  return (
    <div className="min-h-screen bg-white">
      <section className="bg-gray-900 py-12 md:py-20 xl:py-24">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8">
          ...
          <div className="max-w-3xl">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">Training & Compliance Services</h1>
      ...
      <section className="py-10 md:py-16 xl:py-20">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Building a certified, compliant workforce</h2>
      ...
      <section className="py-10 md:py-16 bg-gray-50">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Our Training & Compliance Services</h2>
      ...
      <section className="py-10 md:py-16 xl:py-20">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">From assessment to ongoing compliance</h2>
      ...
      <section className="py-10 md:py-16 bg-gray-900">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">Who we train</h2>
      ...
      <section className="py-10 md:py-16 bg-gray-100">
        <div className="max-w-7xl xl:max-w-[1400px] mx-auto px-4 sm:px-6 xl:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Ready to certify your workforce?</h2>
